...
- Validation:
  - `swift test` passed: 100 tests on 2026-06-19 after removing the expanded-interface bridge.
  - `./script/build_and_run.sh --verify` passed on 2026-06-19 after removing the expanded-interface bridge.
